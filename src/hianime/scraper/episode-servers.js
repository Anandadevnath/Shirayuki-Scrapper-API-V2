...
export const getHiAnimeEpisodeServers = async ({ animeEpisodeId, ep }) => {
  ...
  return {
    ...
    note:
      'HiAnime protects direct server-list ajax with dynamic request signatures. This response is a structured fallback derived from the watch page and episode counts.',
  };
};
